namespace Core.Models
{
    public class ProfileClient
    {
        ...
        private ProfileClient(Guid profileId, Guid clientId, string email, string phone, byte[] username, byte[] password, byte[] secretKey)
        {
            ProfileId = profileId;
            ClientId = clientId;
            Email = email;
        ...
        public static (ProfileClient? ProfileClient, string Error) Create(Guid profileId, Guid clientId, string email, string phone, byte[] username, byte[] password, byte[] secretKey)
        {
