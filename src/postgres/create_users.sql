...
GRANT ALL PRIVILEGES ON DATABASE car_for_sale TO admin_cfs;
...
GRANT SELECT, INSERT, UPDATE ON test_drivers TO salesman_cfs;
...
GRANT INSERT ON clients TO guest_cfs;
GRANT INSERT ON profile_clients TO guest_cfs;
